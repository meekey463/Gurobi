...
cl_price_ret.hist(bins = 10, figsize = (20, 15))
...
wts4_min_risk.plot.bar(title = 'ret:{},risk:{}'.format(ret4_min_risk,round(min(risk),2)), color = 'green')


#weighted_expected_stock_return =pd.DataFrame()
weighted_expected_stock_return= wts4_min_risk
